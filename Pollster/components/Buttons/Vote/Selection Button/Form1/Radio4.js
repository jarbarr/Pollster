...
const RadioButton4 = (props) => {
  // const [isPress, setIsPress] = useState(false);
  const select = () => {
    if (props.isPress4 === false) {
      props.setIsPress4(true);
    } else {
      ...
      <View style={styles.padding}>
        {/* <TouchableOpacity> */}
          <TouchableOpacity style={styles.button} onPress={(e) => {
            ...
            props.setIsPress4(!props.isPress4);
            props.setIsPress5(false);
            props.setIsPress6(false);
            props.setIsPress7(false);
            props.setForm1('GLORIA LA RIVA | SUNIL FREEMAN')
            }}/>
            {props.isPress4 ? <TouchableOpacity style={styles.buttonPress}/> : null}
        {/* </TouchableOpacity>¸ */}
      </View>
    </>
  );
