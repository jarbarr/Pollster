              ...
              <View style={styles.choice}>
                <View style={styles.options}>
                  <View style={styles.measure}>
                    ...
                    <Text style={styles.sectionSubTitle}>EXIME A LAS EMPRESAS DE TRANSPORTE Y ENTREGA BASADAS EN APLICACIONES DE PROPORCIONAR BENEFICIOS PARA EMPLEADOS A DETERMINADOS CONDUCTORES. LEY POR INICIATIVA. <Text style={styles.sectionInfo}> Clasifica a los conductores de empresas basadas en aplicaciones como "contratistas independientes," en lugar de "empleados," y proporciona a los conductores contratistas independientes otra compensación, a menos que se cumplan ciertos criterios. Impacto fiscal: Aumento menor en los impuestos estatales sobre la renta pagados por los conductores e inversores de la empresa de viaje compartido y entrega.</Text></Text>
                  </View>
