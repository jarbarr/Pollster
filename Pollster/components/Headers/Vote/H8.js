    ...
    <>
      <View style={styles.view}>
        <View style={styles.delimiter}>
          ...
          <Text style={styles.h1}>DISTRITO</Text>
        <View style={styles.subHeader}>
          <Text style={styles.h2}>AC TRANSIT DISTRICT DIRECTOR, AT -LARGE</Text>
          <Text style={styles.h2}>DIRECTOR DEL DISTRITO DE AC TRANSIT, EN GENERAL</Text>
