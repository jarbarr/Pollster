      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.regView}>
            ...
            {page === 2 ? <Register3 fetchKeys={props.fetchKeys} addUser={props.addUser} reminder={props.reminder} setReminder={props.setReminder} close={props.close} page={page} setPage={setPage} setForm3={props.form3}/> : null}
          </View>
        </View>
      </Modal>
    </>
